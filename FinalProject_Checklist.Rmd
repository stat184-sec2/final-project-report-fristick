...
(A) .Rmd Line numbers where at least two different data sources are imported: 28, 34, 44 


(B) .Rmd Line numbers for inspecting data intake: 56, 61, 67, 72


### Data Wrangling / Cleaning / ect (5 out of 7 required)


(A) .Rmd Line number(s) for general data wrangling: 81,85,95, 105, 118, 138


(B) .Rmd Line number(s) for a join operation: 104


(C) .Rmd Line number(s) for a pivot_wider or pivot_longer operation (or equivalent): 81,85


(D) .Rmd Line number(s) for use of regular expressions: 127


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 95, 118, 128
...
(A) .Rmd Line numbers for use of multiple different geoms: 157, 158, 169 

(B) .Rmd Line number(s) for use of multiple aesthetics:  157, 158, 159, 168, 170

(C) .Rmd Line number(s) for use of layered graphics: 157, 158
